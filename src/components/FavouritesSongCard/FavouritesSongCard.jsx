    ...
    <div className='flex w-full items-center justify-center h-full'>
      <div className='w-full md:max-w-2xl lg:max-w-3xl min-w-[100%] pt-2'>
        <div className='flex items-center rounded-xl bg-box-icons h-16'>
          ...
          <span className="text-xs text-center w-2/12 md:text-md grow truncate">{name}</span>
          ...
          <p className="text-xs text-center font-normal w-3/12 md:text-md truncate">{artist}</p>
