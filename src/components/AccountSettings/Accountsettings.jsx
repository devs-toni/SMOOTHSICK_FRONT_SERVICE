...
const Accountsettings = () => {
    return (
        ...
        <div className="flex justify-center items-center flex-col pt-20 gap-7 ">
            <div className='flex flex-row justify-around border border-whiteflex w-full'>
                <div>
            ...
            <div className='flex flex-row justify-around border border-whiteflex w-full h-40'>
                <div>
                    <p>Plant Details</p>
                </div>
            ...
            <div className='flex flex-row justify-around border border-whiteflex w-full h-50'>
