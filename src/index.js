...
export * from './components/ChangePasswordComponents/ChangePassword';
...
export { default as OutputBox } from './components/partials/OutputBox';
export { default as Slider } from './components/partials/Slider';
export * from './config';
